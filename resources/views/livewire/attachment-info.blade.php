            ...
            <div>
                @if($attachment->isImage())
                    <img
                        ...
                        class="relative rounded-lg focus-within:ring-2 focus-within:ring-offset-4 focus-within:ring-offset-gray-100 focus-within:ring-primary-600 h-full w-auto max-h-48 m-auto"
                    >
                @endif
