        ...
        <template x-if="attachment !== null">
            ...
            >
                ...
                <div class="absolute top-4 right-4" x-on:click.stop="">
                    <x-filament::dropdown placement="bottom-end" x-show="attachment.type === 'attachment' && !$store.attachmentBrowser?.isSelected(attachment.id, statePath)">
                        <x-slot name="trigger">
                            <x-filament::icon
                    ...
                    <x-filament::dropdown placement="bottom-end" x-show="attachment.type === 'directory' && !$store.attachmentBrowser?.isSelected(attachment.id, statePath)">
                        <x-slot name="trigger">
                            <x-filament::icon
                                    icon="heroicon-o-ellipsis-vertical"
                                    class="w-8 h-8 m-0"
